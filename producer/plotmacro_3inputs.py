...
parser.add_argument('--input_C', required=True, type=str, nargs='+', help="third input file")
...
parser.add_argument('--channel_B', required=True, type=str, 
       help="ditau, mutau, etau, VBFasymtau_uppertauleg, VBFasymtau_lowertauleg, ditaujet_tauleg, ditaujet_jetleg, VBFditau_old,\
       or VBFditau_Run3_tauleg")
parser.add_argument('--channel_C', required=True, type=str, 
       help="ditau, mutau, etau, VBFasymtau_uppertauleg, VBFasymtau_lowertauleg, ditaujet_tauleg, ditaujet_jetleg, VBFditau_old,\
       or VBFditau_Run3_tauleg")
...
def plot_comparison(h_num_os, h_den_os, plottingVariable, channels, add_to_label, plotName, legends=["run 2022","run 2023"," 124X mc"]):
...
if __name__ == "__main__":
    ...
    h_num_os_C, h_den_os_C = obtain_histograms(df_C, channel_C, args.iseta, plottingVariable)
